...
int main() {
    ...
    while(n>0){
        ...
        if(operation == "pi") {
            ...
            cout <<"The retrieved productions (Pi) is " << pi<< endl<<"\n";
...
cout << "The formula to retrieve Attractions is Aj = (beta1*rfs) + (beta2*emp) + beta0." << "\n"<<"First enter the values of each to calculate."<< endl;
            ...
            cout << "The retrieved attractions (Aj) is " << aj<< endl<<"\n";
            ...
            cout <<"The retrieved Fij is " << F_ij << endl<<"\n";
            ...
            cout <<"The retrieved Tij is " << T_ij << endl<<"\n";
